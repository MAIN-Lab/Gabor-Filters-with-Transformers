...
#    model_1= models.transunet_2d(input_shape, filter_num=[16, 32, 64, 128, 256], n_labels=1, stack_num_down=2, stack_num_up=2,
...
#                                    name=('TransUnet_1'))
#
#    model_2= models.transunet_2d(input_shape, filter_num=[16, 32, 64, 128, 256], n_labels=1, stack_num_down=2, stack_num_up=2,
#                                    embed_dim=768, num_mlp=3072, num_heads=2, num_transformer=2,
#                                    activation='ReLU', 
#                                    mlp_activation='GELU',
#                                    #mlp_activation='ReLU',
...
#                                    name=('TransUnet_2'))
    ...
    #model_1=Model(inputs=input_1, outputs=model_1)
...
#    model_21=Model(inputs=model_2.input, outputs=model_2)
    ...
    model_3= models.transunet_2d(input_shape, filter_num=[16, 32, 64, 128, 256], n_labels=1, stack_num_down=2, stack_num_up=2,
                                    embed_dim=embed_dim, num_mlp=num_mlp, num_heads=numberHeads, num_transformer=transformersNumbers,
                                    activation='ReLU', 
                                    mlp_activation='GELU',
                                    #mlp_activation='ReLU',
...
#    model_3=Model(inputs=model_3.input, outputs=model_3)
    ...
    model_4= models.transunet_2d(input_shape, filter_num=[16, 32, 64, 128, 256], n_labels=1, stack_num_down=2, stack_num_up=2,
                                    embed_dim=embed_dim, num_mlp=num_mlp, num_heads=numberHeads, num_transformer=transformersNumbers,
                                    activation='ReLU', 
                                    mlp_activation='GELU',
                                    #mlp_activation='ReLU',
